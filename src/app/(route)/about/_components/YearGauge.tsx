export default function YearGauge({
  ...
  const gaugeCSS = `flex flex-col justify-center rounded-full overflow-hidden bg-teal-400 text-xs text-white text-center whitespace-nowrap transition duration-500 dark:bg-teal-500`;
    ...
    <>
      <div className="max-w-[600px]">
        <ul className="mt-2 flex items-center gap-x-1 mb-2">
          <li className="whitespace-nowrap mr-2 italic dark:text-teal-400 font-medium text-teal-700 bg-teal-100 dark:bg-teal-900 rounded-md text-xs p-1.5">{fullPercentYear} Year</li>
          ...
          {Array.from({ length: 12-fullPercentYear }).map((_, index) => (
        ...
        <ul>
          ...
          <li className="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700">
